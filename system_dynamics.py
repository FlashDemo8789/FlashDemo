...
def system_dynamics_sim(user_initial=1000, 
                       ...
                       seasonality=False):
    """
    HPC synergy BFS–free system dynamics:
    - referral inflow
    - marketing inflow
    - churn outflow
...
def virality_sim(user_initial=100,
    ...
    """
    HPC synergy BFS–free K-factor viral growth simulation.
...
def run_sensitivity_analysis(params: dict, param_ranges: dict):
    """
    HPC synergy BFS–free placeholder from NEW(UI) code,
